 ...
 * 
<<<<<<< HEAD
 * Classe de manuten̤̣o do vetor de cartas
=======
...
=======
  static  String[][] cartasDeRetorno = new String[33][5];
  
  public static void setCartas(){
    
    String[][] cartas = new String[33][5];
>>>>>>> e8671a74c32abdd53198f5075bb90f8391927f0d
...
<<<<<<< HEAD
  ...
  public static String[][] getCartaById(int cartaId){
    ...
    //Procura a carta na matriz pelo valor passado em par̢metro
...
=======
  ...
  public static String[][] getCartaById(int cartaId){
    ...
    //String[][] todasCartas = Leitura.cartasDeRetorno;
    
    cartaUnica[0][0] = Leitura.cartasDeRetorno[cartaId][0];
    cartaUnica[0][1] = Leitura.cartasDeRetorno[cartaId][1];
    cartaUnica[0][2] = Leitura.cartasDeRetorno[cartaId][2];
    cartaUnica[0][3] = Leitura.cartasDeRetorno[cartaId][3];
    cartaUnica[0][4] = Leitura.cartasDeRetorno[cartaId][4];
...
=======
  public static String getCartaByString(int cartaId){
    ...
    String ret = "";
    ret += " === Dados da carta === ";
    ret += "\n Nome personagem : "+dadosCarta[0][0];
    ret += "\n Soco : "+dadosCarta[0][1];
